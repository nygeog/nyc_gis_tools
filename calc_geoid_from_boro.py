...
#### Actual Dropbox blocks
print 'create and calc geoid for nyc dcp census 2010 block'
input_block_file = "W:/GIS/Data/Municipal/USA/New_York/New_York_City/Census/nycb2010_11a_av/nycb2010.shp"
new_field_name = "geoid"
field_type = "TEXT"
...
print 'create and calc geoid for nyc dcp census 2000 block'
input_block_file = "W:/GIS/Data/Municipal/USA/New_York/New_York_City/Census/nycb2000_11a_av/nycb2000.shp"
new_field_name = "geoid"
field_type = "TEXT"

CalcBorotoCountyExpr  = "boroCountyFIPS(int(!BoroCode!), !CT2000!, !CB2000!)"
CalcBorotoCountyBlock = """def boroCountyFIPS(boro,tract, block):
  st = '36'
  if boro == 1:
    return st + '061' + tract + block
